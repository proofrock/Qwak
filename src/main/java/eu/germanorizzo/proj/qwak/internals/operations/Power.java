...
public class Power implements Operations.Performable {
    @Override
    public Operand perform(Operand... operands) throws EvalException {
        ...
        switch (o1.getType()) {
            case STRING:
                throw new EvalException("Cannot POWER on strings");
            case NUM:
                switch (o2.getType()) {
                    case STRING:
                        throw new EvalException("Cannot POWER on strings");
                    case NUM:
                        ...
                        return Operand.numItem(((BigDecimal) o1.getValue()).pow(v2));
                    case BOOL:
                        throw new EvalException("Cannot POWER on booleans");
                    case NULL:
                        throw new EvalException("Cannot POWER on nulls");
                }
            case BOOL:
                throw new EvalException("Cannot POWER on booleans");
            case NULL:
        ...
        throw new EvalException("Invalid parameters combination for POWER");
    }
}
